...
public class ToolSelector extends Actor {
    ...
    public ToolSelector(final com.pixelpalette.DrawStage parent) {
    ...
    public void draw(Batch batch, float parentAlpha) {
        float maxSize = 18 * pixelSize * (parent.getCanvas().tools.length - 1) - (com.pixelpalette.PixelApp.height - 18 * pixelSize - parent.getColorPicker().getHeight());
        if(scroll > maxSize) {
            scroll = maxSize;
        }
        if(scroll < 0) {
        ...
        spr.setSize(18 * pixelSize, com.pixelpalette.PixelApp.height - 18 * pixelSize);
