...
public class ColorPicker extends Actor {
    ...
    private int dragNum;
    private com.pixelpalette.HSVColor hsv;
    ...
    public ColorPicker(com.pixelpalette.DrawStage parent) {
        this.parent = parent;
        ...
        hsv = new com.pixelpalette.HSVColor();
        displayHSV = false;
        ...
        if (x >= 15 * pixelSize && x <= 53 * pixelSize)
        {
            if (displayHSV)
            {
                if (y > 45 * pixelSize)
                {
                    ...
                    }, "Set new hue (0-360)", Integer.toString((int)hsv.getH()), "");
                }
                else if (y > 31 * pixelSize)
                {
                    ...
                    }, "Set new saturation (0-100)", Integer.toString((int)hsv.getS()), "");
                }
                else if (y > 17 * pixelSize)
                {
                    ...
                    }, "Set new value (0-100)", Integer.toString((int)hsv.getV()), "");
                }
                else if (y > 3 * pixelSize)
                {
                    ...
                    }, "Set new alpha (0-100)", Integer.toString((int)hsv.getA()), "");
                }
            }
            else
            {
                if (y > 45 * pixelSize)
                {
                    ...
                    }, "Set new red value (0-255)", Integer.toString(getR(col[curCol ? 1 : 0])), "");
                }
                else if (y > 31 * pixelSize)
                {
                    Gdx.input.getTextInput(new Input.TextInputListener() {
                    ...
                    }, "Set new green value (0-255)", Integer.toString(getG(col[curCol ? 1 : 0])), "");
                }
                else if (y > 17 * pixelSize)
                {
                    Gdx.input.getTextInput(new Input.TextInputListener() {
                    ...
                    }, "Set new blue value (0-255)", Integer.toString(getB(col[curCol ? 1 : 0])), "");
                }
                else if (y > 3 * pixelSize)
                {
                    Gdx.input.getTextInput(new Input.TextInputListener() {
                    ...
                    }, "Set new alpha value (0-255)", Integer.toString(getA(col[curCol ? 1 : 0])), "");
                }
            }
        }
