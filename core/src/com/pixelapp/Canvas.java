...
import com.pixelapp.SpecificUndoActions.PixmapUndoAction;
import com.pixelapp.SpecificUndoActions.SelectUndoAction;
...
public class Canvas extends Actor {
    ...
    public final Tool[] tools = new Tool[] {
            ...
            new Tool() {
                private PencilOptions pencilOptions;
                ...
                public void touchUp(float pointerX, float pointerY) {
                    ...
                    if(drawMode && edit != null) {
                        ...
                        if(changeMade) {
                            UndoAction action = new PixmapUndoAction(Canvas.this, oldPixmap, curLayer);
                ...
                @Override
                public void setOptions(final ToolOptions options) {
                    if(options instanceof PencilOptions) {
                        pencilOptions = (PencilOptions)options;
                    }
                }
            ...
            new Tool() {
                ...
                public void touchUp(float pointerX, float pointerY) {
                    ...
                    if(changeMade && undoPixmap != null) {
                        processor.clearRedo();
                        UndoAction action = new PixmapUndoAction(Canvas.this, undoPixmap, curLayer);
                        processor.addToUndo(action);
                        undoPixmap.dispose();
                        updateLayerDraw();
                    }
                ...
                @Override
                public void setOptions(final ToolOptions options) {
                    if(options instanceof EraserOptions) {
                        eraserOptions = (EraserOptions) options;
                    }
                }
            ...
            new Tool() {
                ...
                public void touchUp(float pointerX, float pointerY) {
                    if(drawMode) {
                        processor.clearRedo();
                        PixmapUndoAction action = new PixmapUndoAction(Canvas.this, layers.get(curLayer), curLayer);
                        processor.addToUndo(action);
                ...
                @Override
                public void setOptions(final ToolOptions options) {
                    if(options instanceof FillOptions) {
            ...
            new Tool() {
                private ColorSelectOptions options;
                ...
                @Override
                public void setOptions(final ToolOptions options) {
                    if(options instanceof ColorSelectOptions) {
                        this.options = (ColorSelectOptions) options;
                    }
                }
            }, // Color picker
            new Tool() {
                private SquareSelectOptions options;
                ...
                public void touchUp(float pointerX, float pointerY) {
                    if(drawMode) {
                        if(!options.multiClick || options.secondTouch) {
                            ...
                            SelectUndoAction action = new SelectUndoAction(oldMask, parent.getSelectionMask(), parent, Canvas.this);
                            processor.addToUndo(action);
                            processor.clearRedo();
                ...
                @Override
                public void setOptions(final ToolOptions options) {
                    if(options instanceof SquareSelectOptions) {
                        this.options = (SquareSelectOptions) options;
                    }
                }
            }, // Square select tool
            new Tool() {
                ...
                private WandSelectOptions options;
                ...
                @Override
                public void setOptions(final ToolOptions options) {
                    if(options instanceof WandSelectOptions) {
                        this.options = (WandSelectOptions) options;
                    }
                }
            ...
            new Tool() {
                private PenSelectOptions options;
                private boolean changeMade;
                ...
                public void touchUp(float pointerX, float pointerY) {
                    ...
                    if(changeMade && oldArea != null) {
                        processor.clearRedo();
                        SelectUndoAction action = new SelectUndoAction(oldArea, parent.getSelectionMask(), parent, Canvas.this);
                        processor.addToUndo(action);
                    }
                ...
                @Override
                public void setOptions(final ToolOptions options) {
                    if(options instanceof PenSelectOptions) {
                        this.options = (PenSelectOptions) options;
                    }
                }
    ...
    private void redrawPaper() {
        ...
        Pixmap paperTexture = MANAGER.get("Paper.png");
    ...
    public void liftSelection() {
        ...
        if(width > 0 && height > 0) {
            ...
            PixmapUndoAction action = new PixmapUndoAction(this, edit, curLayer);
            processor.addToUndo(action);
            processor.clearRedo();
